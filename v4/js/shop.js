(() => {
  ...
  const injectDrawer = () => {
    ...
    wrap.innerHTML =
      ...
      "<li>" +
      '<svg class="pays__ico" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M18.32 2.86 13.7 7.48a2.4 2.4 0 0 1-3.4 0L5.68 2.86A2.15 2.15 0 1 0 2.64 5.9l4.62 4.62a2.4 2.4 0 0 1 0 3.4L2.64 18.54A2.15 2.15 0 1 0 5.68 21.58l4.62-4.62a2.4 2.4 0 0 1 3.4 0l4.62 4.62a2.15 2.15 0 1 0 3.04-3.04l-4.62-4.62a2.4 2.4 0 0 1 0-3.4l4.62-4.62a2.15 2.15 0 1 0-3.04-3.04Z"/></svg>' +
      '<span data-i18n="product.pix">PIX</span>' +
      "</li>" +
      "<li>" +
