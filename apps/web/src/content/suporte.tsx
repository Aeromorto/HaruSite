      ...
      <main id="conteudo">
        <article className="product">
          <div className="product__gallery">
            <figure className="product__shot">
              <img src="/images/product-suporte.jpg" alt={t("p3.alt")} />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-suporte-2.jpg" alt="" />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-suporte-3.jpg" alt="" />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-suporte-4.jpg" alt="" />
            </figure>
          </div>
          ...
          <div className="product__info">
            ...
            <h1 className="product__name">{t("p3.name")}</h1>

            <ProductPrice id="p3" />

            <p className="product__lead">{t("p3.desc")}</p>

            <ProductActions id="p3" />
        ...
        <section className="also" aria-labelledby="alsoTitle">
          ...
          <div className="also__grid">
            <Link className="also__item" href="/escova">
              <img
                src="/images/product-escova.jpg"
                alt={t("p1.alt")}
                width="480"
                height="480"
              />
