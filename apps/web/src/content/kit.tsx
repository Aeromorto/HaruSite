        ...
        <article className="product">
          <div className="product__gallery">
            <figure className="product__shot">
              <img src="/images/product-kit.jpg" alt={t("p2.alt")} />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-kit-2.jpg" alt="" />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-kit-3.jpg" alt="" />
            </figure>

            <figure className="product__shot">
              <img src="/images/product-kit-4.jpg" alt="" />
            </figure>
          </div>
          ...
          <div className="product__info">
            ...
            <h1 className="product__name">{t("p2.name")}</h1>

            <ProductPrice id="p2" />

            <p className="product__lead">{t("p2.desc")}</p>

            <ProductActions id="p2" />
